...
const RichTextEditor = ({ accounts, returnContent, convertedContent }) => {
  ...
  return (
    <>
      <div className='description-container text-sm p-3 relative border rounded-md'>
        <MentionSuggestions
          open={open}
          ...
          popoverContainer={({ children }) => (
            <div className='bg-lightGrey mt-24 ml-4 py-3 absolute z-50 rounded-md shadow-dark'>
              {children}
            </div>
          )}
        />
