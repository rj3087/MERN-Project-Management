        ...
        >
          <div className='pt-12 pl-8 pr-8'>
            <ExclamationCircleIcon
              ...
              aria-hidden='true'
            ></ExclamationCircleIcon>
            <h4 className='w-3/4 text-xl font-bold text-center tracking-wider mx-auto pt-6 pb-2 break-words'>
              {title}
            </h4>
          </div>
          ...
          <div className='mb-12 mx-auto flex'>
            <motion.button
              type='button'
              className='bg-primary w-1/9 text-white text-sm font-medium tracking-wider py-4 px-12 rounded-md shadow-xl'
